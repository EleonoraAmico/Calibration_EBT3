...
def test_process_values_od_mode_edge_case_x():
    """Tests that process_values correctly calculates optical density for edge
    case.
...
def test_process_values_net_od_missing_y():
    """Tests that process_values raises error when y values are missing in
    NET_OD mode.
...
def test_process_values_net_od_no_zero():
    """Tests that process_values raises error when no zero point exists in
    NET_OD mode.
...
def test_process_values_net_od_x_zero():
    """Tests that process_values raises a ValueError when x is equal to 0 for y
    equal to 0 in NET_OD mode.
