...
class TestExponentialFunctions:
    ...
    def test_exponential_increasing_basic(self):
        """Tests that _exponential function produces expected output for simple
        input.
    ...
    def test_exponential_with_offset_increasing_trend(self):
        """Tests that _exponential_with_offset function produces expected
        output.
    ...
    def test_combination_of_exponential_with_zero_parameters(self,a, b, c, d):
        """Tests that _double_exponential raises ValueError for zero
        parameters.
    ...
    def test_combination_of_exponential_edge_case(self):
        """Tests the exponential difference function with extreme parameter
        values.
...
class TestGeneralizedRational:
    """Test suite for typical cases, edge cases and boundary conditions of
    ...
    def test_hyperbolic_growth_typical(self):
        """Tests the hyperbolic growth function with typical input values on
        the generalized rational function.
    ...
    def test_hyperbolic_growth_properties(self,x, a, b, c, d, e):
        """Tests general properties of the hyperbolic growth function using
    ...
    def test_asymptotic_behavior(self):
        """Test the asymptotic behavior of the generalized rational function as
