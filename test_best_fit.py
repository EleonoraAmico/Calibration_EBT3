...
class TestNonLinearFunctions: 
    ...
    def exponential_data(self, fitter):
        """Generate exponential data using CurveFitter's _exponential function"""
    ...
    def combination_exp_data(self, fitter):
        """Generate combination of exponentials data using CurveFitter's _combination_of_exponential function"""
    ...
    def rational_data(self, fitter):
        """Generate rational function data using CurveFitter's _generalized_rational"""
...
class TestBestFitEdgeCasesNotPolynomialFunctions:
    ...
    def test_single_exp_fit_edge_cases_fixed_coefficients(self, fitter, x_min, x_max, n_points, a = 5, b = -7, c = 3):
        """
        Test the robustness and accuracy of the single exponential fitting function.
    ...
    def test_exp_function_fitting_accuracy_on_edge_cases(self, fitter, x_min, x_max, n_points, a = 5, b = -7, c = 3):
        """
        Test the fitting accuracy and robustness of the selection of best fit for
        exponential function under edge cases.
    ...
    def test_combination_of_exp_fit_edge_cases(self, fitter, x_min, x_max, n_points):
        """
        Test the robustness and accuracy of the fitting function for the combination of exponential. 
    ...
    def test_rational_fit_edge_cases(self, fitter, x_min, x_max, n_points):
        """
        Test the robustness and accuracy of the fitting function for the generalized rational. 
    ...
    def test_log_fit_edge_cases(self, fitter, x_min, x_max, n_points):
        """
        Test the robustness and accuracy of the fitting function for the log function. 
    ...
    def test_log_function_fitting_accuracy_on_edge_cases(self, fitter, x_min, x_max, n_points):
        """
        Test the fitting accuracy and robustness of the selection of best fit for
        logarithmic function under edge cases.
...
class TestBestPropertyBasedNonLinearFunctions:
    ...
    def test_single_exp_fit_different_coefficients(self, fitter, a, b, c):
        """
        Test the fitting of a decreasing exponential function works correctly with 
        randomly selected coefficients a, b and c and it behaves as expected for values of x ranging
        from 0 to 65535, with y constrained between 0 and 50.
    ...
    def test_exp_fit_different_coefficients_with_noise(self, fitter, a, b, c):
        """
        Test of an exponential function to non-uniform noisy data and randomly
        selected coefficients a, b and c
    ...
    def test_combination_of_exp_fit_unfixed_coefficients(self, fitter, a, b, c, d):
        """
        Test the fitting of a combination of exponential function (sum and difference of exponential)
        works correctly with randomly selected coefficients a, b, c and d and it behaves as expected for 
        values of x ranging from 0 to 65535, with y constrained between 0 and 50.
    ...
    def test_double_exp_fit_unfixed_coefficients_noise(self, fitter, a, b, c, d):
        """
        Test the fitting of a combination of exponential function (sum and difference of exponential)
        works correctly with randomly selected coefficients a, b and c and it behaves as expected for 
        values of x ranging from 0 to 65535, with y constrained between 0 and 50.
        GIVEN: A combination of exponential y = a*e^(b*x) + c*e^(d*x) , where:
                - the range of values for the coefficients is:
                  - a in [-10, 10],
    ...
    def test_rational_fit_different_coefficients(self, fitter, a, b, c, d, e):
        ...
        selected coefficients a, b and c and it behaves as expected for 
        values of x ranging from 0 to 65535, with y constrained between 0 and 50.
    ...
    def test_rational_fit_with_noise(self, fitter, a, b, c, d, e):
        """
        Test of an exponential function to non-uniform noisy data and randomly
        selected coefficients a, b, c, d and e 
        GIVEN: -A set of non-uniformly distributed x values between 20,000 and 50,000
               -And Gaussian noise with standard deviation of 100
               -And exponential function parameters a, b, and c
        WHEN:  -y values are generated using the exponential function 
    ...
    def test_log_ratio_fit(self, fitter, a, b):
        """
        Test the fitting of a log function works correctly with 
        randomly selected coefficients a and b and it behaves as expected for values of x ranging
        from 0 to 65535, with y constrained between 0 and 50.
