...
def validate_data(x, y):
    ...
    if not all(0 <= val <= 50 for val in y):
        ...
        return False
    return True
def polynomial_fit_0(x, y, fitting_results, max_degree=4):
    """
...
def calculate_best_fit(x, y, title, mode=ProcessingMode.PV ):
    ...
    poly_mse, best_degree, best_coefficients, fitting_results = polynomial_fit_0(x_processed, y, fitting_results)
    best_mse = poly_mse
